...
export type GetAllCertsQueryVariables = Exact<{
  locale: Scalars['I18NLocaleCode']['input'];
}>;


export type GetAllCertsQuery = { __typename?: 'Query', certs?: { __typename?: 'CertEntityResponseCollection', data: Array<{ __typename?: 'CertEntity', id?: string | null, attributes?: { __typename?: 'Cert', locale?: string | null, title: string, received: any, issuer: string, info: string, url?: string | null, doc?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | null }> } | null };

export type GetAllEdsQueryVariables = Exact<{
  locale: Scalars['I18NLocaleCode']['input'];
}>;


export type GetAllEdsQuery = { __typename?: 'Query', eds?: { __typename?: 'EdEntityResponseCollection', data: Array<{ __typename?: 'EdEntity', id?: string | null, attributes?: { __typename?: 'Ed', locale?: string | null, institute: string, start: any, end?: any | null, degree: string, url?: string | null, grade: string, doc?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | null }> } | null };
...
export type GetAllXpsQueryVariables = Exact<{
  locale: Scalars['I18NLocaleCode']['input'];
}>;


export type GetAllXpsQuery = { __typename?: 'Query', xps?: { __typename?: 'XpEntityResponseCollection', data: Array<{ __typename?: 'XpEntity', id?: string | null, attributes?: { __typename?: 'Xp', locale?: string | null, position: string, company: string, info: string, start: any, end?: any | null, url?: string | null } | null }> } | null };


export const GetAllCertsDocument = gql`
  ...
  certs(locale: $locale, sort: "received:desc") {
    ...
    `;
export const GetAllEdsDocument = gql`
...
export const GetVolunteersDocument = gql`
  ...
  volunteers(locale: $locale, sort: "start:desc") {
    ...
    `;
export const GetAllXpsDocument = gql`
    query GetAllXps($locale: I18NLocaleCode!) {
  xps(locale: $locale) {
    data {
      id
      attributes {
...
export function getSdk<C>(requester: Requester<C>) {
  return {
    GetAllCerts(variables: GetAllCertsQueryVariables, options?: C): Promise<GetAllCertsQuery> {
      return requester<GetAllCertsQuery, GetAllCertsQueryVariables>(GetAllCertsDocument, variables, options) as Promise<GetAllCertsQuery>;
    },
    GetAllEds(variables: GetAllEdsQueryVariables, options?: C): Promise<GetAllEdsQuery> {
      return requester<GetAllEdsQuery, GetAllEdsQueryVariables>(GetAllEdsDocument, variables, options) as Promise<GetAllEdsQuery>;
    },
    GetInfo(variables: GetInfoQueryVariables, options?: C): Promise<GetInfoQuery> {
      return requester<GetInfoQuery, GetInfoQueryVariables>(GetInfoDocument, variables, options) as Promise<GetInfoQuery>;
    },
    GetInterests(variables: GetInterestsQueryVariables, options?: C): Promise<GetInterestsQuery> {
      return requester<GetInterestsQuery, GetInterestsQueryVariables>(GetInterestsDocument, variables, options) as Promise<GetInterestsQuery>;
    },
    GetLangs(variables: GetLangsQueryVariables, options?: C): Promise<GetLangsQuery> {
      return requester<GetLangsQuery, GetLangsQueryVariables>(GetLangsDocument, variables, options) as Promise<GetLangsQuery>;
    },
    ...
    GetAllSkills(variables: GetAllSkillsQueryVariables, options?: C): Promise<GetAllSkillsQuery> {
      return requester<GetAllSkillsQuery, GetAllSkillsQueryVariables>(GetAllSkillsDocument, variables, options) as Promise<GetAllSkillsQuery>;
    },
    GetVolunteers(variables: GetVolunteersQueryVariables, options?: C): Promise<GetVolunteersQuery> {
      return requester<GetVolunteersQuery, GetVolunteersQueryVariables>(GetVolunteersDocument, variables, options) as Promise<GetVolunteersQuery>;
    },
    GetAllXps(variables: GetAllXpsQueryVariables, options?: C): Promise<GetAllXpsQuery> {
      return requester<GetAllXpsQuery, GetAllXpsQueryVariables>(GetAllXpsDocument, variables, options) as Promise<GetAllXpsQuery>;
    }
  };
}
